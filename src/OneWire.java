...
public class OneWire implements Protocol
{
	...
	private int		portID;					// Port ID for the OneWire protocol

	public	OneWire(String logDir, int portID)	// Constructor to initialize the log directory and port ID
	{
		this.logDir = logDir;
		this.portID = portID;
	...
	@Override public void	write(String data)	// Write data to the OneWire protocol
	{
		logEntries.add("Writing \"" + data + "\".");
	}

	@Override public void	close()				// Close the OneWire protocol
	{
