class Wifi implements Device {
    ...
    @Override public String getName() { return "Wifi"; }
    @Override public String getDevType() { return "WirelessIO"; }
    @Override public String getSensType() { return ""; }
    @Override public State getState() { return state; }
    @Override public void turnON() { state = State.ON; protocol.write("turnON"); System.out.println("Wifi: Turning ON."); }
    @Override public void turnOFF() { state = State.OFF; protocol.write("turnOFF"); System.out.println("Wifi: Turning OFF."); }
